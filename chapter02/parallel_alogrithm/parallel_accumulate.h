...
#ifndef C__11_MULTITHREADCODE_PARALLEL_ACCUMULATE_H
#define C__11_MULTITHREADCODE_PARALLEL_ACCUMULATE_H
#include <algorithm>
#include <numeric>
#include <thread>
#include <vector>
...
template<typename Iterator, typename T>
T  parallel_accumulate(Iterator first, Iterator last, T result) {
...
#endif //C__11_MULTITHREADCODE_PARALLEL_ACCUMULATE_H
